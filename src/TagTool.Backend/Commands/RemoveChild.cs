...
public class RemoveChildRequest : ICommand<OneOf<string, ErrorResponse>>
{
...
public class RemoveChild : ICommandHandler<RemoveChildRequest, OneOf<string, ErrorResponse>>
{
    ...
    public async Task<OneOf<string, ErrorResponse>> Handle(RemoveChildRequest request, CancellationToken cancellationToken)
    {
